...
class Posting_model extends CI_Model {
   ...
   public function uploadImage(){
      ...
      // Buat salinan gambar ke folder medium
      $config['image_library'] = 'gd2';
      $config['source_image'] = './images/posting/' . $file_name;
      $config['new_image'] = './images/posting/medium/' . $file_name;
   ...
   public function deleteImage($fileName){
      ...
      if(file_exists("./images/posting/medium/$fileName")){
        unlink("./images/posting/medium/$fileName");
      }
   }
